...
# ==================== 硬编码配置参数 ====================
CHECKPOINT_PATH = '/home/gml-cwl/code/graspnet-baseline/logs/log_kn/checkpoint.tar'  # 修改为你的权重路径
NUM_POINT = 20000
NUM_VIEW = 300
...
WORKSPACE_MASK_PATH = '/home/gml-cwl/code/graspnet-baseline/mask.png'
...
def run_grasp_inference(color_path, depth_path, sam_mask_path=None):
    ...
    if  not top_grasps:
        print("\n[Warning] No valid grasp predictions after filtering.")
...
if __name__ == '__main__':
    # 示例：使用文件路径
    color_img_path = '/home/gml-cwl/code/graspnet-baseline/doc/example_data/color.png'
    depth_img_path = '/home/gml-cwl/code/graspnet-baseline/doc/example_data/depth.png'
    # sam_mask_path 为 SAM 生成的目标分割掩码，用于过滤不在目标区域内的抓取预测
    sam_mask_path = '/home/gml-cwl/code/graspnet-baseline/mask.png'
